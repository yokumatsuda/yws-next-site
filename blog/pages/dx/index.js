  ...
  const accordionItemsDX = [
    {
      ...
      **📢 まずは無料相談から！**  
      ...
      `,
      image: "/services-img/dx/dx-image22.jpg",
    },
    {
      title: "業務自動化",
      subtitle:
      ...
      **📢 まずは無料相談から！**  
      ...
      `,
      image: "/services-img/dx/dx-image26.jpg",
    },
    {
      title: "ペーパーレス化",
      subtitle:
      ...
      **📢 まずは無料相談から！**  
      ...
      `,
      image: "/services-img/dx/paperless_10.jpg",
    },
  ];
  ...
  const accordionItemsEfficiency = [
    ...
    },
    {
      ...
      **📢 まずは無料相談から！**  
      ...
      `,
      image: "/services-img/dx/dx-image29.jpg",
    },
    {
      ...
      **📢 まずは無料相談から！**  
      ...
      `,
      image: "/services-img/dx/dx-image17.jpg",
    },
  ];
  ...
  const accordionItemsPaperless = [
    {
      ...
      **📢 まずは無料相談から！**  
      ...
      `,
      image: "/services-img/dx/dx-image3.jpg",
    },
    {
      title: "電子契約サービス",
      subtitle:
      ...
      **📢 まずは無料相談から！**  
      ...
      `,
      image: "/services-img/dx/cloud2.jpg",
    },
    {
      title: "デジタル書類の共有",
      subtitle:
      ...
      **📢 まずは無料相談から！**  
      ...
      `,
      image: "/services-img/dx/dx-image46.jpg",
    },
  ];
